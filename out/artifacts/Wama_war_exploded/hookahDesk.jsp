...
<table border="1">
    ...
    <tbody>
    <% if (arrP1 != null) {
        ArrayList<PrepareOrder> arrP = null;
        for (int i = 0; i < arrP1.size(); i++) {
            String result = arrP1.get(i).getOrderNumber();
            System.out.println(result);
            arrP = (ArrayList<PrepareOrder>) control.prepareOrderHookah(result);%>
    ...
    <tr>
      <%for (int k = 0; k < arrP.size(); k++) {
        ...
        <td><a href="narghileaDeskServlet?id=<%=arrP1.get(i).getOrderNumber()%>"><input type="submit" value="Ready"/></a></td>
      <%break;}}%>
    </tr>
    <%
