...
<table border="1">
    ...
    <% if (arrP1 != null) {
        ...
        for (int i = 0; i < arrP1.size(); i++) {
            ...
            arrP = (ArrayList<PrepareOrder>) control.prepareOrderKitchen(result);%>
    ...
    <tr>
      <% for (int k = 0; k < arrP.size(); k++) {
        ...
        %>
            ...
            <%   }%></td>
        <td><a href="kitchenDeskServlet?id=<%=arrP1.get(i).getOrderNumber()%>"><input type="submit" value="Ready"/></a></td>
      <%break;}}%>
    </tr>
    <%
